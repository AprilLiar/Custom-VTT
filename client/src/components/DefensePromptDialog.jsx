...
//
// Delivered through CombatHeaderBar's global dialog queue rather than mounted
// inside the Arena, so it reaches the GM wherever they are in the app — the
// paused pair's round cannot continue until they answer, and they may well be
// looking at a different fight (or a character sheet). dismissible={false} for
// the same reason MoveConflictDialog is: the pause is real game state that
// needs *an* answer, not a dialog to wave away.
const KIND = {
  dodge: {
